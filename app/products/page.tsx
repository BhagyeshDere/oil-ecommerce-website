        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          {oils.map((oil, i) => (
            ...
            >
              ...
              {/* 🌟 BADGE */}
              <div className="absolute top-4 left-4 bg-[#c8a24c] text-white text-[10px] px-3 py-1 rounded-full font-bold shadow">
                Premium
              </div>
              ...
              <div className="px-4 py-5 space-y-3">
                ...
                {/* BUTTON */}
                <button className="w-full mt-2 h-11 bg-[#0b3d33] text-white rounded-xl flex items-center justify-center gap-2 text-xs font-black uppercase tracking-widest hover:bg-[#0f7b65] transition-all">
