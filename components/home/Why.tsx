  ...
  return (
    <section className="relative py-32 px-6 md:px-12 overflow-hidden bg-[#fcfcf9]">
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
        ...
        {/* 🖼️ THE VISUAL ANCHOR: CUSTOM SHAPE IMAGE */}
        <motion.div
        ...
        >
          ...
          <div className="relative h-[400px] md:h-[600px] w-full rounded-tr-[8rem] md:rounded-tr-[12rem] rounded-bl-[8rem] md:rounded-bl-[12rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] group">
            <Image
              src="/images/wood-press-process.png"
              alt="Wood Pressed Oil Process"
              fill
            ...
            <motion.div 
              ...
              className="absolute bottom-10 left-10 right-10 p-6 bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl text-white"
            >
              <p className="text-[10px] font-black uppercase tracking-[0.3em] mb-1 opacity-80">Methodology</p>
              <p className="text-sm md:text-lg font-serif italic italic">"Slow churned at 14 RPM to preserve the soul of the seed."</p>
            </motion.div>
          </div>
        </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {benefits.map((item, i) => (
                ...
                >
                  ...
                  <h4 className="font-bold text-[#0b3d33] mb-1 group-hover:text-[#c8a24c] transition-colors uppercase tracking-tight">
                    {item.title}
                  </h4>
            ...
            <div className="flex items-center gap-8 pt-4">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="group flex items-center gap-4 px-8 py-4 bg-[#0b3d33] text-white rounded-full font-bold text-xs uppercase tracking-widest shadow-2xl shadow-[#0b3d33]/20 overflow-hidden relative"
              >
              ...
              <button className="hidden md:block text-[#0b3d33] font-black text-[10px] uppercase tracking-[0.3em] border-b-2 border-[#c8a24c] pb-1 hover:text-[#c8a24c] transition-all">
